...
Parser.prototype.before = function(str) {
  var index = getPos(this, str, undefined);
...
Parser.prototype.after = function(str) {
  var index = getPosAfter(this, str, 0);
...
Parser.prototype.between = function(start, end) {
  var indexStart = getPosAfter(this, start, 0);
  var indexEnd = getPos(this, end, undefined);
  return this.content.slice(indexStart, indexEnd);
};
...
function getPosAfter(self, str, def) {
  var index = def;
  switch(typeof str) {
    case 'number':
      index = str;
